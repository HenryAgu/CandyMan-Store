...
const page = () => {
	...
	return (
		<div className="mx-auto h-full px-0 w-full">
			...
			<div className="mx-auto py-16 lg:px-16 container">
				...
				<div className="my-32 mt-24 lg:mt-48 w-full mx-auto">
					...
					<div className="grid lg:grid-cols-3 justify-center lg:justify-between gap-x-5 gap-y-10 lg:gap-y-20 mt-5">
						{theLatest.map((latestItem) => (
							<div key={latestItem.id}>
								<Image
			...
			<div className="bg-black mb-20 mx-auto container">
				<div className="py-[90px] mx-auto flex flex-col gap-y-2 lg:gap-y-5">
					<h1 className="font-inter font-semibold text-3xl lg:text-[54px] text-white">
						Follow us on social for more
					</h1>
					<button type="button" className="bg-white text-black w-fit text-xs px-5 py-3 lg:text-sm font-inter font-semibold lg:py-5 lg:px-12 rounded-lg">
						@Everlane Instagram
					</button>
				</div>
			</div>
