  ...
  return (
    <div className="mx-auto h-full px-0 w-full">
      ...
      <div className="mx-auto container">
        <div className="flex flex-col gap-y-2 lg:flex-row lg:gap-x-6 mx-auto lg:my-20">
...
const ProductDetailsSidebar = ({
  ...
  return (
    <div className=" basis-[70%] shrink-0">
      <div className="w-full lg:w-11/12 lg:grid grid-cols-1  mt-5 lg:mt-0 gap-2">
    ...
    <div className="flex flex-col gap-y-5 basis-[30%] h-fit shrink-0">
      ...
      <div className="mt-5">
        ...
        <div className="flex mt-3 gap-x-3">
          <button
            type="button"
            className="bg-candy-gray-100 p-3 h-[40px] w-[45px] flex items-center justify-center text-primary font-inter font-normal text-xs"
          >
            XS
          </button>
          <button
