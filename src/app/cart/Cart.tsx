...
const Cart = () => {
  return (
    <div className="mt-4">
      <h1 className="font-inter font-semibold text-xl lg:text-2xl px-3 lg:px-6">Your Cart</h1>
      <div className="my-4">
        <ScrollArea className="h-[65vh] lg:h-[50vh] lg:mt-2 px-3 lg:px-6">
        ...
        <div className="flex flex-col gap-y-4 px-3 lg:px-6 py-4 lg:py-8 absolute w-full bottom-0 bg-white">
          <div className="flex items-center justify-between">
            <h3 className="font-inter text-black font-semibold text-sm lg:text-base">Subtotal <span className="font-normal text-xs lg:text-sm">(2 items)</span></h3>
            <h3 className="font-inter text-black font-semibold text-sm lg:text-base">$202</h3>
          </div>
          <button className="uppercase bg-candy-dark-900 text-white py-3 font-inter font-normal text-xs lg:text-sm tracking-[1.4px] leading-[16.8px]">continue to checkout</button>
