		...
		<>
			<main className="">
				...
				<div className="mx-auto px-0 container">
					<div className="bg-[url('/assets/MobileShop.png')] bg-center bg-cover bg-no-repeat lg:bg-[url('/assets/Hero.png')] h-[800px] w-full">
...
const Category = () => {
	...
	return (
		<div className="mx-auto my-10 lg:my-14 h-full px-0 w-full container">
			...
			<div className="hidden lg:grid md:grid-cols-2 md:gap-3 lg:grid-cols-3 gap-y-3 lg:gap-x-3 my-10 lg:my-20 ">
				<div className="bg-[url('/assets/image.png')] bg-center bg-cover bg-no-repeat h-[534px] flex flex-col gap-y-3.5 items-center justify-center group hover:grayscale">
					...
					<Link href="">
						<button
							type="button"
							className="font-inter uppercase mx-auto lg:mx-auto font-normal text-sm text-[#262626] bg-white py-3 px-10 opacity-0 transition-opacity duration-1000 group-hover:opacity-100"
						>
							shop the latest
						</button>
					</Link>
			...
			<div className="grid lg:hidden md:grid-cols-2 md:gap-3 lg:grid-cols-3 gap-y-5 lg:gap-x-3 my-10 lg:my-20 w-11/12 lg:w-full mx-auto">
				<div className="bg-[url('/assets/image.png')] bg-center bg-cover bg-no-repeat h-[534px] w-full flex flex-col gap-y-3.5 items-center justify-center">
					...
					<Link href="">
						<button
							type="button"
							className="font-inter uppercase mx-auto lg:mx-auto font-normal text-sm text-[#262626] bg-white py-3 px-10"
						>
							shop the latest
						</button>
					</Link>
